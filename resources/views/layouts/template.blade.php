...
<head>
 ...
 ============================================ -->
    ...
    <!-- Bootstrap CSS -->
    <!--mise à jour css page après envoi contact informations-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-6 col-4">
                    <div class="logo">
                        <a href="index.html">
                            <img alt="" src="assets/img/logo/logo.png" href="{{route('home.accueil')}}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8 d-none d-lg-block">
                    <div class="main-menu">
                        <nav>
                            <ul>
                                <li><a href="{{route('home.accueil')}}">Home <i class="fa fa-angle-down"></i></a>
                                        ...
                                        <li>
                                            <ul>
                                                <li class="mega-menu-img"><a href="shop.html"><img
                                                            src="assets/img/banner/banner-12.png" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('home.accueil') }}">Home</a></li>
                                <li><a href="{{ route('home.produits') }}"> Produits <i
                            ...
                            <div class="quickview-wrap mt-15">
                                <div class="quickview-slide-active owl-carousel nav nav-style-1" role="tablist">
                                    <a class="active" data-bs-toggle="tab" href="#pro-1"><img
                                            src="{{asset("assets/img/product/quickview-s1.jpg")}}" alt=""></a>
                                    <a data-bs-toggle="tab" href="#pro-2"><img
                                            src="{{asset("assets/img/product/quickview-s2.jpg")}}" alt=""></a>
                                    <a data-bs-toggle="tab" href="#pro-3"><img
                                            src="{{asset("assets/img/product/quickview-s3.jpg")}}" alt=""></a>
